-- Affiliate / davet komisyonu istatistiklerinde iade ve iptal edilen siparişleri düş
-- supabase-referral-program-phase3-mentor-stats.sql ve supabase-mentor-self-billing-invoice.sql sonrasında çalıştırın.

CREATE OR REPLACE FUNCTION public.package_order_counts_for_referral_stats (po public.package_orders)
RETURNS boolean
LANGUAGE sql
IMMUTABLE
AS $$
...
COMMENT ON FUNCTION public.package_order_counts_for_referral_stats (public.package_orders) IS
  'İade talebi veya iade edilmiş siparişleri affiliate istatistiklerinden hariç tutar.';
...
-- Cüzdan özetindeki davet komisyonu: iade satırlarını da netle
